...
<div class="md:flex mt-8 mb-8">
    ...
    <div class="w-full md:w-1/3">  
    <a class="underline" href="{{ site.baseurl }}/announcement/">
    <button class="block w-full bg-red-500 hover:bg-red-400 focus:bg-red-700 transition-colors text-white rounded-lg px-3 py-2 font-semibold"> 
         Следующая >   
    </button>
     </a>
     </div>
...
<div class="text-md text-center mb-8">
  Проанализировано командой <a class="underline" href=""> Salutem </a>
